...
const profileOptions = [
  {
    ...
    link: router.push("/select-payment-method"),
  },
  {
    ...
    <>
      ...
      <View className="flex-1 bg-white px-4">
        ...
        <View className="items-center mb-6">
          <Image
            source={{
              uri: "https://images.unsplash.com/photo-1604072366595-e75dc92d6bdc?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fHJ1c3NpYW4lMjB3b21hbnxlbnwwfHwwfHx8MA%3D%3D",
            }}
        ...
        >
          {profileOptions.map((item, index) => (
            <TouchableOpacity
              key={index}
              onPress={() => {
                router.push("/(app)/(bookings)/bookings");
              }}
            ...
            >
              <View className="flex-row items-center">
                ...
                <Text className="text-sm font-poppinSemiBold">
                  {item.title}
                </Text>
              </View>
              <StyledComponent
